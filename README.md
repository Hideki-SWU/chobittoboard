...
- Issues: [GitHub Issues](https://github.com/username/chobittoboard/issues)
- Discussions: [GitHub Discussions](https://github.com/username/chobittoboard/discussions)
